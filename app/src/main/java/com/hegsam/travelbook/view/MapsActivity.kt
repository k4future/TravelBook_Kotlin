...
import com.hegsam.travelbook.databinding.ActivityMapsBinding
import com.hegsam.travelbook.model.Place
import com.hegsam.travelbook.roomdb.PlaceDao
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    fun save (view : View)
    {
        val place = Place(binding.placeText.text.toString().trim(),selectedLatitude!!,selectedLongitude!!)
